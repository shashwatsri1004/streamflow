...
export const ALL_MOVIES: Movie[] = [
  ...
  { id: 'goa-trip', title: 'Goa Trip', description: 'Sun, sand, and your laughter echoing across the shore. The trip that made us realize we could be anywhere in the world as long as we were together.', year: 2023, duration: '2h 10m', genre: ['Adventure', 'Romance'], rating: '10/10', image: img(1), category: 'continue-watching', emoji: '🏖️' },
  { id: 'late-night-calls', title: 'Late Night Calls', description: 'Those 3AM conversations where we solved the world\'s problems and discovered each other\'s deepest thoughts. Time zones didn\'t matter. Sleep didn\'t matter. Only you.', year: 2022, duration: '∞', genre: ['Romance', 'Comedy'], rating: '10/10', image: img(2), category: 'continue-watching', emoji: '🌙' },
  { id: 'random-laughs', title: 'Our Random Laughs', description: 'A compilation of every time we laughed until we couldn\'t breathe. Warning: May cause uncontrollable happiness, stomach pain from laughing, and an overwhelming desire to repeat everything.', year: 2023, duration: '3h 22m', genre: ['Comedy', 'Documentary'], rating: '10/10', image: img(3), category: 'continue-watching', emoji: '😂' },
  { id: 'our-fights', title: 'Our Fights 😂', description: 'A dramatic retelling of every argument that lasted approximately 15 minutes before one of us started laughing. Spoiler: Nobody won. Love always did.', year: 2023, duration: '18m', genre: ['Comedy', 'Drama'], rating: '10/10', image: img(4), category: 'continue-watching', emoji: '😤' },
  { id: 'birthday-surprise', title: 'Girlfriends Day Surprise', description: 'The moment crafted with love and nerves and a lot of planning. This is that moment — your day — a memory being made right now, just for you.', year: 2024, duration: '1h 0m', genre: ['Romance', 'Special'], rating: '∞', image: img(5), category: 'continue-watching', emoji: '🎂' },

  // Row 2 - Because You Exist
  { id: 'day-we-met', title: 'The Day We Met', description: 'Chapter one of the greatest story ever written. The universe conspired, schedules aligned, and somehow we ended up in the same place at the right moment. A masterpiece of coincidence.', year: 2022, duration: '2h 5m', genre: ['Romance', 'Drama'], rating: '10/10', image: img(6), category: 'because-you-exist', emoji: '✨' },
  { id: 'smile-wins', title: 'The Smile That Wins', description: 'A documentary about the one smile that has the power to fix any bad day, silence any argument, and remind me exactly why I am the luckiest person alive.', year: 2022, duration: '1h 30m', genre: ['Documentary', 'Romance'], rating: '10/10', image: img(7), category: 'because-you-exist', emoji: '😊' },
  { id: 'cute-habits', title: 'Your Cute Habits', description: 'The way you hum while reading. The way you overthink texts. The way you eat the last bite and then feel guilty. Every weird, wonderful, adorable habit that makes you irreplacably you.', year: 2023, duration: '1h 55m', genre: ['Documentary', 'Comedy'], rating: '10/10', image: img(8), category: 'because-you-exist', emoji: '🐱' },
  { id: 'favorite-memories', title: 'Favorite Memories', description: 'A carefully curated collection of moments that I replay in my mind constantly. These are the memories that make my heart full and my smile impossible to hide.', year: 2023, duration: '2h 40m', genre: ['Drama', 'Romance'], rating: '10/10', image: img(9), category: 'because-you-exist', emoji: '💝' },
  { id: 'moments-ill-never-forget', title: "Moments I'll Never Forget", description: 'Some memories are so perfect they feel like dreams. This is a tribute to every moment that lodged itself permanently into my heart — and refused to leave.', year: 2023, duration: '3h 15m', genre: ['Drama', 'Romance'], rating: '10/10', image: img(10), category: 'because-you-exist', emoji: '💫' },
  ...
  { id: 'hidden-voice-notes', title: 'Hidden Voice Notes', description: 'The voice notes I recorded when I was missing you too much and couldn\'t find the right words to text. Press play. Listen. Feel.', year: 2023, duration: '45m', genre: ['Romance', 'Personal'], rating: '10/10', image: img(12), category: 'top-picks', emoji: '🎙️' },
  { id: 'cute-videos', title: 'Cute Videos', description: 'Every video that made me go "I need to show her this" — a collection of things that made me think of you, feel happy because of you, or smile because you exist.', year: 2023, duration: '2h 0m', genre: ['Comedy', 'Heartwarming'], rating: '10/10', image: img(13), category: 'top-picks', emoji: '🎬' },
  { id: 'favorite-photos', title: 'Favorite Photos', description: 'A gallery of my absolute favorites. The candid ones. The silly ones. The ones you didn\'t know I took. The ones where you weren\'t looking but you were still the most beautiful thing in the frame.', year: 2023, duration: '1h 30m', genre: ['Documentary', 'Visual'], rating: '10/10', image: img(14), category: 'top-picks', emoji: '📸' },
  { id: 'letters', title: 'Letters', description: 'Words I wrote at midnight when feelings were too big to keep inside. Letters I may never have sent, but every word is real and every sentence is you.', year: 2024, duration: '∞', genre: ['Drama', 'Romance'], rating: '10/10', image: img(15), category: 'top-picks', emoji: '💌' },

  // Row 4 - Comedy Specials
  { id: 'weird-faces', title: 'Your Weird Faces', description: 'An award-winning collection of expressions that should absolutely be illegal but are somehow the most endearing thing I\'ve ever witnessed. Oscars coming soon.', year: 2023, duration: '1h 10m', genre: ['Comedy', 'Documentary'], rating: '10/10', image: img(16), category: 'comedy', emoji: '😜' },
  { id: 'embarrassing-moments', title: 'My Embarrassing Moments', description: 'A raw, unfiltered look at every time I tried to be smooth and spectacularly failed. Watched exclusively by you, who somehow still chose me anyway. Incredible.', year: 2023, duration: '2h 5m', genre: ['Comedy', 'Reality'], rating: '10/10', image: img(17), category: 'comedy', emoji: '🤦' },
  { id: 'funny-videos', title: 'Funny Videos', description: 'The ones that made you snort-laugh. The ones that made you send "I\'m deceased 💀". An unfiltered celebration of the joy we share in the smallest, silliest things.', year: 2023, duration: '3h 0m', genre: ['Comedy', 'Compilation'], rating: '10/10', image: img(18), category: 'comedy', emoji: '🤣' },
  { id: 'blooper-reel', title: 'Blooper Reel', description: 'Every plan that went sideways. Every attempt at being romantic that turned into chaos. Every perfect disaster we somehow made into a perfect memory.', year: 2023, duration: '1h 45m', genre: ['Comedy', 'Behind-the-Scenes'], rating: '10/10', image: img(19), category: 'comedy', emoji: '🎬' },
  { id: 'unexpected-laughs', title: 'Unexpected Laughs', description: 'The kind of laughter that comes out of nowhere and takes over completely — in serious moments, quiet moments, random moments. The laughter I never want to lose.', year: 2023, duration: '2h 20m', genre: ['Comedy', 'Romance'], rating: '10/10', image: img(20), category: 'comedy', emoji: '😹' },
