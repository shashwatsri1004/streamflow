...
export const ALL_MOVIES: Movie[] = [
  ...
  { id: 'birthday-surprise', title: 'Birthday Surprise', description: 'The moment crafted with love and nerves and a lot of planning. This is that moment — your birthday — a memory being made right now, just for you.', year: 2024, duration: '1h 0m', genre: ['Romance', 'Special'], rating: '∞', image: img(5), category: 'continue-watching', emoji: '🎂' },
